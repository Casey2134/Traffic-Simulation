...
public class Simulation {
    ...
    public double[] run(double time, int intervalForBuses, int numberOfBuses) {
        arrival = new Arrival(1800, numberOfBuses);
        totalTime = time;
    ...
    public double[] getData() {
        ...
        double averageSpeed = averageSpeedTotal / averageSpeedValues;
        double averageTime = averageTimeTotal / averageTimeValues;
        double averageDistance = averageDistanceTotal / averageDistanceValues;
...
//                averageDistanceValues, totalPeopleTravelled, totalTime };
        double[] data = new double[] {averageSpeed, averageTime,
                totalBusPassengers, totalCarPassengers, numOfBusses, numOfCars, numOfVehicles, averageDistance, totalPeopleTravelled};
        return data;
