public class Lane {
    ...
    public static void unitTest() {
        ...
        System.out.println("Enqueue Bus 1: " + lane.enqueue(bus1)); // Expected: true if space, false otherwise

        // Test: Get the number of vehicles in the lane
        System.out.println("Number of vehicles: " + lane.getNumOfVehicles()); // Expected: 2 or 3
        ...
        System.out.println("Remaining Space: " + lane.getRemainingSpace()); // Should reflect space after removing
                                                                               // car1
    }
}